"""
CrossFit Open 2026 – 26.1 Leaderboard Dashboard
...
st.set_page_config(page_title="CrossFit Open 26.1", layout="centered", initial_sidebar_state="collapsed")
...
st.markdown(
    ...
    f'<h1 style="margin:0; font-size:1.8rem; color:{TEXT_COLOR};">CROSSFIT OPEN 26.1</h1>'
    f'</div>',
    unsafe_allow_html=True,
)
